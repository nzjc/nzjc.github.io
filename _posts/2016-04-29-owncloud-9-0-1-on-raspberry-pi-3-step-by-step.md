...
This section you can skip if you already have a freshly installed Raspberry Pi 3 running [Raspbian](https://www.raspbian.org/).
  ...
  3. Run the raspi-config tool - you can set your hostname, expand the file system (use all of your SD card, not just a couple of GB)  
    ...
    [<img loading="lazy" class=" wp-image-83 aligncenter" src="/wp-content/uploads/2016/04/rpi-conf.png?resize=494%2C181&#038;ssl=1" alt="rpi-conf" width="494" height="181" srcset="/wp-content/uploads/2016/04/rpi-conf.png?resize=300%2C110&ssl=1 300w, /wp-content/uploads/2016/04/rpi-conf.png?resize=768%2C281&ssl=1 768w, /wp-content/uploads/2016/04/rpi-conf.png?resize=1024%2C374&ssl=1 1024w, /wp-content/uploads/2016/04/rpi-conf.png?w=1144&ssl=1 1144w" sizes="(max-width: 494px) 85vw, 494px" data-recalc-dims="1" />](/wp-content/uploads/2016/04/rpi-conf.png?ssl=1)In there, I suggest you run Option 1 and 2. Inside Option 9, I set the Memory Split to 4MB (this is mostly a headless install, why waste RAM on a GPU that won't get much use), and enable SSH. I changed the hostname to 'cloud', pick a name you like. Finish up, then reboot the Pi  
